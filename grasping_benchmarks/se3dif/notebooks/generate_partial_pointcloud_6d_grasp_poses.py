# This script is taken form the original repository to analyse the generated grasps without
...
def parse_args():
    ...
    p.add_argument("--obj_class", type=str, default="Banana")
...
def get_approximated_grasp_diffusion_field(p, device="cpu"):
    ...
    generator = Grasp_AnnealedLD(
        model, batch=batch, T=70, T_fit=50, k_steps=1, device=device
    )
