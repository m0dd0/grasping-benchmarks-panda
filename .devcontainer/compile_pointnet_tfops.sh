...
cd /home/ContactGraspnetBenchmark/contact_graspnet/orig/pointnet2/tf_ops/grouping
...
cd ../3d_interpolation
cd /home/ContactGraspnetBenchmark/contact_graspnet/orig/pointnet2/tf_ops/3d_interpolation
